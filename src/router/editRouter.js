...
editRouter.route("/:id/project").post(imageAndVideoUploadFiles.fields([{name:"imagefile",maxCount:10},{name:"videofile",maxCount:1}]),postProject).put(putProject).delete(deleteProject);
